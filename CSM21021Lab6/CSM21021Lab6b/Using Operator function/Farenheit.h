...
class Farenheit{
    ...
    public:
        Farenheit(double = 0.0);
        double getTemperature()const{return temperatureInfar;}
        operator Celsius()const; //operator casting function --farenheit to celsius
...
class Celsius{
    ...
    public:
        ...
        operator Farenheit()const; //operator casting function -- celsius tp farenheit
...
Celsius::operator Farenheit()const{
    double temperature = temperatureInCel*9/5+32;
